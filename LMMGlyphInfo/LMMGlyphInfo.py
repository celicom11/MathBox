...
Ord = 0,LOP,Bin,Rel,Open,Close,Punct,Accent,Over,Under 
    ...
    # Relations
    if codepoint in (0x003C,0x003D,0x003E,0x2050,0x2208,0x2209,0x220A,0x220B,0x220C,0x220D,0x221D,
                     0x2322,0x2323,0x27C2,0x27DA,0x27DB,0x27DC,0x27DD,0x27DE,
                     0x2906,0x2907,0x2A95,0x2A96,0x2AAF,0x2AB0,0x2B31,0x2B33):
        return 3
    if (codepoint >= 0x2190 and codepoint <= 0x21F6) or (codepoint >= 0x2223 and codepoint <= 0x22F1) or\
