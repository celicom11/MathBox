...
### 🚧 In Progress
- **LaTeX Parser: UnitTests to cover existing implementation (w/o Commands/Builders)**
- **LaTeX Parser: Some basic commands**
...
- **Boxed** - \boxed{} support
- **Matrix/Array Environment + tabulation (&)** - \begin(cases)...\end{cases} support
